...
const FeatureCard = ({ heading, para, img = '🤝' }) => {
    return (
        <div className="realative rounded-xl max-w-[25rem] md:max-w-[35rem] featuredCard flex justify-center items-center md:flex-row flex-col lg:p-[2rem] p-[3vh] mx-[1rem] border-4 feature-card">
